...
//Added by Anish
import android.media.DemoSigmaMgr;
...
public final class SystemServiceRegistry {
	...
	// Added by Anish
	registerService(Context.SIGMA_SERVICE, DemoSigmaMgr.class,
		new CachedServiceFetcher<DemoSigmaMgr>() {
	    @Override
            public DemoSigmaMgr createService(ContextImpl ctx) {
		return new DemoSigmaMgr();
	    }});
